"""
Django settings for noisy_snowflake_46736 project.
...
ROOT_URLCONF = 'noisy_snowflake_46736.urls'
...
WSGI_APPLICATION = 'noisy_snowflake_46736.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_snowflake_46736 API",
    "DESCRIPTION": "API documentation for noisy_snowflake_46736 App",
    "VERSION": "v1",
}
